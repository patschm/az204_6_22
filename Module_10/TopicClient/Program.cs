...
namespace TopicClient
{
    class Program
    {
        ...
        static (string Name, string Key) SasKeyManager = ("Manager", "882akeXdtA9eTNq5CBDG9qy8zE1NnAUMGzABqO+4/Y0=");
        static (string Name, string Key) SasKeyWriter = ("Writer", "Qbs5qbkBjqUdlXEdS+GZv338hnJmXEsaiyQ/QPRq5j4=");
